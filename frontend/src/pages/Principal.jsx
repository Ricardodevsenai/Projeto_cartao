...
export default function Dashboard() {
  return (
// Layout geral
<div style={{ display: "flex", height: "100vh", width: "100vw", backgroundColor: "#4b0082", }}>
  ...
  >
    ...
    />
    <div style={{ display: "flex", flexDirection: "column", gap: "100px", margin: "auto" }}>
      <Link to="" ><FaHome size={24} color="white" /></Link>
      <Link to="/alunos"><MdPeopleAlt size={24} color="white" /></Link>
      <Link to="/turmas"><FaGraduationCap size={24} color="white" /></Link>
    </div>
  ...
  >
    ...
    >
      ...
      <div style={{ display: "flex", gap: "20px", marginBottom: "30px" }}>
        <div style={{ flex: 1, backgroundColor: "#f4ebfa", padding: "20px", borderRadius: "15px" }}>
      ...
      <table className="table table-hover">
        ...
        <tbody className="table-group-divider">
          <tr>
            <td>10/05/2025</td>
            <td>João Silva</td>
            <td>Matriculou-se em "React Básico"</td>
          </tr>
          <tr>
            <td>09/05/2025</td>
            <td>Maria Lima</td>
            <td>Concluiu "HTML Avançado"</td>
          </tr>
          <tr>
            <td>08/05/2025</td>
            <td>Pedro Santos</td>
            <td>Criou nova conta</td>
          </tr>
        </tbody>
      </table>
    </div>
