  ...
  return (
    ...
    >
      ...
      >
        ...
        >
            <h2 style={{ color: "#4b0082", marginBottom: "30px" }}>Cadastro de Turmas</h2>
            ...
            <form style={{ maxWidth: "600px" }}>
                ...
                <div style={{flexDirection: "row", justifyContent: "space-around"}}>
                    <button type="submit" className="btn btn-primary" style={{ backgroundColor: "#4b0082", border: "none", marginRight: 10 }}>
                    Cadastrar
                    </button>

                    <Link to="/turmas">
                        <button type="submit" className="btn btn-primary" style={{ backgroundColor: "#4b0082", border: "none" }}>
                        Cancelar
                        </button>
                    </Link>
                </div>
